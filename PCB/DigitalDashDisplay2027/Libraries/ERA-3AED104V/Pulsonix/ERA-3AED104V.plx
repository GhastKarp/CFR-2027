...
//2031200/1676590/2.50/2/2/Resistor
...
(library Library_1
	...
	(symbolDef "ERA-3AED104V" (originalName "ERA-3AED104V")
	...
	(compDef "ERA-3AED104V" (originalName "ERA-3AED104V") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ERA-3AED104V"))
		...
		(attr "Manufacturer_Part_Number" "ERA-3AED104V")
		(attr "Mouser Part Number" "667-ERA-3AED104V")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Panasonic/ERA-3AED104V?qs=MNPzkKEzRtQIWcmUWL4kjg%3D%3D")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "Thin Film Resistors - SMD 0603 100Kohms 25ppm 0.5% AEC-Q200")
		(attr "<Hyperlink>" "https://industrial.panasonic.com/cdbs/www-data/pdf/RDM0000/AOA0000C307.pdf")
		(attr "<Component Height>" "0.55")
		(attr "<STEP Filename>" "ERA-3AED104V.stp")
